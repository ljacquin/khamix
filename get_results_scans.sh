...
if [ "$kernel_index" -gt 1 ] ; then
    ...
    if [ "$nb_snp_hap" -gt 1 ] ; then
        ...
        do
            ...
            mv index_significant_windows_chromo_num_$chromo_num_k*					results_chromo_num_$chromo_num_k
        ...
        do
            ...
            mv index_significant_snps_chromo_num_$chromo_num_k*						results_chromo_num_$chromo_num_k
